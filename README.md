...
La relación de Character y Episode será de muchos a muchos, ya que un personaje puede aparecer en varios episodios, y en un episodio pueden aparecer varios personajes.
...
- [ ] Paginado
- [ ] Botón para filtrar por personajes traidos de la API o creados en la DB
- [ ] GET /character/:id
